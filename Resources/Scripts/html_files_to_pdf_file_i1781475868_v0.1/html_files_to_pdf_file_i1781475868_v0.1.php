...
$var_7e7480cd_return_boo = ritchey_markup_file_to_html_files_i1781384111_v1("{$var_7e7480cd_base_path_str}/Temporary 2/Example Document 1/Input/Markup.txt", "{$var_7e7480cd_base_path_str}/Temporary 2/Example Document 1/Output", "{$var_7e7480cd_base_path_str}/Source/Assets/cv-resume-portfolio-theme-v1.css", TRUE, TRUE, TRUE);
...
require_once $var_7e7480cd_base_path_str . '/Resources/Scripts/html_files_to_pdf_file_i1781475868_v0.1/Custom Dependencies/get_recursive_file_list_i1781476833_v0.1.php';
...
unset($item);
natsort($var_7e7480cd_html_chromium_files_arr);
...
unset($item);
natsort($var_7e7480cd_pdf_files_arr);
// Merge all the PDFs
...
$var_7e7480cd_return_boo = fun_f8c1d4a2_combine_pdfs_i1_v0_1(array_reverse($var_7e7480cd_pdf_files_arr), "{$var_7e7480cd_base_path_str}/Temporary 2/Example Document 1/Output/Combined.pdf");
if ($var_7e7480cd_return_boo === TRUE){
	echo "TRUE" . PHP_EOL;
} else {
	echo "FALSE" . PHP_EOL;
